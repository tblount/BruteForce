...
public class gui {
    ...
    public void lock(){
        ...
        numberButtons[0].setFont(new java.awt.Font("Open Sans", 0, 14));
        numberButtons[0].setPreferredSize(new java.awt.Dimension(150, 100));
        ...
        for(int i = 1; i < numberButtons.length; i++ ) {
            ...
            numberButtons[i].setPreferredSize(new java.awt.Dimension(150, 100));
